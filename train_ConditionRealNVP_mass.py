...
plot_per_point      = 50
save_per_point      = 100
output_path         = "output/train_condrealnvp_mass_210113_v1/"
saved_model_name    = "saved_model.h5"

plot_cfgs           = [
        ObjDict(name="pt1",bins=50,range=[0.,10.],index=0,histtype='step',),
        ObjDict(name="pt2",bins=50,range=[0.,5.],index=2,histtype='step',),
